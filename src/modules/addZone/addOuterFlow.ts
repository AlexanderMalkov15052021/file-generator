...
export const addOuterFlow = (mooeDoc: MooeDoc) => {
    ...
    addFlowCachePoints(
        ...
        lastPointId + 1 + firstRowPoints.length + (firstRowPoints.length * 2) + additionalIndexes * 6,
    ...
    addFlowTargetPoints(
        ...
        lastPointId + 1 + firstRowPoints.length + (firstRowPoints.length * 2) + additionalIndexes * 8,
        lastFlowNum + 1,
        Math.PI / 2,
        0
    );
